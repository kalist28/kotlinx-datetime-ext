...
1) Run `./gradlew :kotlinx-datetime-ext:publishToMavenLocal`
2) Open `~/.m2/repository/io/github/kalist28/datetime/ext/`
...
2) Add developer id, name, email and the project url to  
   `./kotlinx-datetime-ext/build.gradle.kts`
...
4) Add these lines to `gradle.properties`:
   ...
   ```
5) Run `./gradlew :kotlinx-datetime-ext:publishAndReleaseToMavenCentral --no-configuration-cache`
