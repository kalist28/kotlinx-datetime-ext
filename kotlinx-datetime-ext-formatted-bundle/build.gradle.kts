...
kotlin {
    ...
    sourceSets {
        commonMain.dependencies {
            implementation(project(":kotlinx-datetime-ext"))
...
android {
    namespace = "io.github.kalist28.datetime.fbundle"
    compileSdk = 35
...
mavenPublishing {
    ...
    coordinates(
        ...
        artifactId = "kotlinx-datetime-fbundle",
